...
public class LBAInvHookImpl implements InventoryComponentHelper.BlockInventoryHook, InventoryComponentHelper.ItemInventoryHook {
	private static final LBAInvHookImpl INSTANCE = new LBAInvHookImpl();
