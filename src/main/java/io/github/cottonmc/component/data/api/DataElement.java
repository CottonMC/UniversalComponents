...
/**
 * <p>Represents a single "line item" of probe information. Usually a DataElement represents the output from one
 ...
 *
 * <p>A DataElement contains several "fields" of information of different types. Every field is optional, and probe
 * implementations are encouraged to rearrange or elide data in order to produce clearer or more visually appealing
 * layouts. Each DataElement line is meant to say something *semantic* about the thing being queried, and ideally no
 * data is presented by a DataElementProvider in a particular way in order to provoke a particular layout.
 *
 ...
 * this is obviously not possible). If a block has two inventories, it should report two separate DataElement lines, each
